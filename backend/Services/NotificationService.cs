...
public class NotificationService
{
    ...
    public async Task<Notification> CreateAsync(int userId, int tenantId, string title, string message, string type, int? relatedEntityId = null, string? relatedEntityType = null)
    {
    ...
    public async Task CreateForSuperAdminsAsync(string title, string message, string type, int? relatedEntityId = null, string? relatedEntityType = null)
    {
