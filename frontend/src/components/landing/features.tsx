...
export default function Features() {
  ...
  return (
    <section className="border-t border-gray-100 bg-gray-50/50 py-20 md:py-28" id="features">
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <h2 className="mt-4 text-3xl font-bold text-gray-900 md:text-4xl">Everything you need to run your space</h2>
          <p className="mt-4 text-lg text-gray-500">Powerful tools designed for modern coworking spaces.</p>
        </motion.div>
