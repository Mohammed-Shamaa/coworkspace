      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
          ...
          <nav className="flex items-center gap-6 text-sm">
            ...
            <Link href="/auth/login" className="text-gray-500 transition-colors hover:text-gray-900">Login</Link>
            <Link href="/auth/register" className="text-gray-500 transition-colors hover:text-gray-900">Register</Link>
          </nav>
        </div>
