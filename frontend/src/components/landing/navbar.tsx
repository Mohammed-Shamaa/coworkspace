    ...
    <header className="fixed top-0 left-0 right-0 z-50 animate-navbar border-b border-blue-100/30 bg-blue-50/60 shadow-sm shadow-blue-500/5 backdrop-blur-xl dark:border-blue-900/20 dark:bg-[#0a0e27]/80 dark:shadow-none">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 md:px-6">
        <Link href="/" className="flex items-center gap-2 md:gap-3 shrink-0">
          <Image src="/logo-48.png" alt="Deskora" width={32} height={32} className="h-7 w-7 md:h-8 md:w-8" />
        ...
        <nav className="flex items-center gap-1 md:gap-2">
          <button
            ...
            className="rounded-lg p-2 md:p-2.5 text-gray-500 transition-colors hover:bg-blue-50 dark:text-gray-400 dark:hover:bg-gray-800"
          >
